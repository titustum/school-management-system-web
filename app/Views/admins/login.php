    ...
    <div class="d-flex flex-center">
      <form class="w-30">
        ...
        <div class="form-title-div d-flex flex-center">
          <div class="form-title">STAFF PORTAL</div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-div d-flex">
            ...
            <input type="Password" class="flex-fill" name="" placeholder="PASSWORD...">
          </div>
        </div>
        <div class="form-group">
          <button type="submit" class="btn btn-info">LOGIN</button>
          <div>
            Forgotten password?<a href="#" class="ml-1">Reset here!</a>
          </div>
          <div>
            Don't have account yet?<a href="<?php echo base_url("account/create");?>" class="ml-1">Create here!</a>
          </div>
        </div>
    </form>
    </div>
