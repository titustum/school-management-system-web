...
<body>
	...
	<div class="full-wh d-flex">
		<div class="border-right border-success full-h left-dashboard-nav" style="width: 15%; position: fixed; overflow-y: auto; height: 100vh !important">
			...
			<div class="d-flex justify-content-center full-w mt-3">
				<a href="./students" class="btn btn-secondary" data-btn="view-students">
		...
		<div class="flex-fill d-flex flex-column justify-content-between" style="margin-left: 15%; overflow: auto;">
			<div class="full-w d-flex flex-column p-2" id="main-content">
				<div class="container pb-3">
					...
					<form>
					  <div class="input-group mb-3">
					    ...
					    <input type="text" class="form-control" value="1" placeholder="Form">
					    <input type="text" class="form-control" value="WEST" placeholder="Stream">
					      <div class="input-group-append">
						    <button class="input-group-button btn btn-success">UPDATE</button>
						  </div>
					  </div>
					</form>	
				</div>
				...
				<div class="table-responsive container">
				  <table class="table table-hover">
				    ...
				    <tbody>
				    	<?php $c=1; foreach ($all_students as $student) : ?>
				    	<tr>
					    	<th><?php echo($c) ;?></th>
					    	<td><?php echo($student['st_id']+600) ;?></td>
					    	<td><?php echo($student['st_names']) ;?></td>
					    	<td><?php echo($student['st_gender']) ;?></td>
					    	<td><?php echo($student['st_class']) ;?></td>
					    	<td><?php echo($student['st_stream']) ;?></td>
					    	<td><?php echo($student['st_parent_name']) ;?></td>
					    	<td><?php echo($student['st_parent_phone']) ;?></td>
					    	<td><a href="<?php echo($student['st_id']) ;?>">VIEW</a></td>
				    	</tr>
				    <?php $c++; endforeach; ?>
